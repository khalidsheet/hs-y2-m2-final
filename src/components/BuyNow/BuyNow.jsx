...
export const BuyNow = () => {
  return (
    <div className="bg-gradient-to-b from-blue-200 h-[500px] flex items-center justify-center flex-col text-center gap-5 px-20 sm:p-0">
      <h1 className="text-2xl sm:text-4xl max-w-3xl font-[600]">
